feature 'Driver checks and updates their balance' do
  ...
  scenario 'They receive a reply with their current balance' do
    ...
    expect_txt_response "Your balance is $12.34, with pending payments of $0.00."
    send_txt "balance"
    ...
    expect_txt_response_to sharer.number, "Your payment of $10.01 has been received. Your balance is now $2.33."
